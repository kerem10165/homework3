...
long long recursiveFunction(int numberOfStones)
{
	...
	//recursive kýsým burada 3'lü toplamalar yapýlýyor çünkü kendinden önceki 3 adým sayýsýnýn toplamý o adýmý veriyor
	else
	{
...
{
	static long long dizi[72] = { 1,2,4 };//ilk üç durumun atamasýný elle yaptým diðer deðerleri o üç duruma göre bulacak
	...
	{
		i = numberOfStones-4;
		for (; i < numberOfStones-1; i++)//bu döngüde kendisinden önceki üç deðeri toplatýp dizideki sýradaki eleman atmasýný saðladým
		{
